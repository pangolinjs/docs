export const sidebar = [
	{
		...
		items: [
			...
			{ text: 'Usage', link: '/v6/guide/usage.html' },
			{ text: 'Components', link: '/v6/guide/components.html' },
			{ text: 'Pangolin.js Core', link: '/v6/guide/pangolin-core.html' },
		],
	},
	{
		text: 'Cookbook',
		items: [
			...
			{ text: 'Vue.js', link: '/v6/cookbook/vue.html' },
		],
	},
]
